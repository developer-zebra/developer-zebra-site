...
var sitebuild = Metalsmith(__dirname)
  ...
  .use(foldermenu({
        folder: 'datawedge/6-6/'
    }))
  .use(foldermenu({
        folder: 'datawedge/6-7/'
    }))
  .use(foldermenu({
        folder: 'datawedge/6-8/'
    }))
  .use(foldermenu({
  ...
  .use(foldermenu({
        folder: 'datawedge/7-4/'
    }))
  .use(foldermenu({
        folder: 'datawedge/7-5/'
    }))
  .use(foldermenu({
        folder: 'datawedge/7-6/'
    }))
  .use(foldermenu({
        folder: 'datawedge/8-0/'
    }))
  .use(foldermenu({
        folder: 'datawedge/8-1/'
    }))
  .use(foldermenu({
        folder: 'datawedge/8-2/'
    }))
  .use(foldermenu({
        folder: 'datawedge/11-0/'
    }))
