...
var sitebuild = Metalsmith(__dirname)
    ...
    //OemConfig 10.3
    .use(foldermenu({
        folder: 'oemconfig/10-3/',
        automenu: true,
        ascontent: true
    }))
    //OemConfig 10.2
    .use(foldermenu({
        folder: 'oemconfig/10-2/',
        automenu: true,
        ascontent: true
    }))
    //OemConfig 10.1
...
//emdk for android 6.7
   ...
   //emdk for android 7.6
    ...
    //emdk for Android 9.0
    
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/',
        automenu: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/barcode',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/core',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/notification',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/payment',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/PersonalShopper',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/scanandpair',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/securenfc',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/serialcomm',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/api/simulscan',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
    ...
    .use(foldermenu({
        folder: 'emdk-for-android/9-0/'
    }))
    
    //emdk for Android 9.1
    
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/',
        automenu: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/barcode',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/core',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/notification',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/payment',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/PersonalShopper',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/scanandpair',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/securenfc',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/serialcomm',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-android/9-1/api/simulscan',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
...
// EMDK for Xamarin 7.0
    ...
    .use(foldermenu({
        folder: 'emdk-for-xamarin/7-0/api/',
        automenu: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-xamarin/7-0/api/simulscan',
        automenu: true,
        ascontent: true
    })) 
    .use(foldermenu({
        folder: 'emdk-for-xamarin/7-0/api/notification',
        automenu: true,
        ascontent: true
    }))    
    .use(foldermenu({
        folder: 'emdk-for-xamarin/7-0/api/scanandpair',
        automenu: true,
        ascontent: true
    }))    
    .use(foldermenu({
        folder: 'emdk-for-xamarin/7-0/api/barcode',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-xamarin/7-0/api/core',
        automenu: true,
        ascontent: true
    }))
    .use(foldermenu({
        folder: 'emdk-for-xamarin/7-0/'
    }))
