---
title: Configuration & Mass Deployment
layout: guide.html
product: DataWedge
productversion: "11.0"
---
...
DataWedge configurations can be configured and deployed through 4 distinct methods:
...
3. **[DataWedge Manager CSP](#datawedgemanagercsp) -** Securely mass deploy DataWedge configuration with the underlying MX framework using StageNow or an EMM.
