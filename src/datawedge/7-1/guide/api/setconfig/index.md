...
<table class="facelift" style="width:70%" border="1" padding="5px">
  ...
  <tr>
	...
	<td>Sets the discrete values 1-6 for translucency of decode notification green screen based on the following table (higher values result to more translucency): <br><br>3 (default)<br>0-6<br><br>
	<table class="facelift" style="width:70%" border="1" padding="5px">
		<tr bgcolor="#dce8ef">
