...
**Note:** On a device with an older DataWedge version (v8.1 or lower) which does not provide [multi-scanner](../input/barcode/#scannerselection) mode support, when a profile is imported with multiple scanners configured it results to any one of the scanners being selected.
