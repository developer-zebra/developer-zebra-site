...
<b>Device Tracker 2.3.1</b> or lower, the <i>on-premise</i> version released in 2019, is now renamed to <b>Device Tracker On-Prem.</b> Android 10 device support, soon-to-be added, is the last Android platform supported. <b>Device Tracker On-Prem</b> is <i>not</i> compatible with the upcoming <b>Device Tracker</b> cloud-based release and cannot be upgraded. <br><br>
<p style="color:black;"><b>Coming soon:</b></p>
<a href="/devicetracker-onprem/transition"><b>Device Tracker</b></a> <i>cloud-based</i>, the next generation version, is being released towards the end of 2020. It is the replacement for <b>Device Tracker On-Prem.</b> For access, contact your local Zebra account manager.<br>
