...
The first time it's installed, EHS offers this simple choice: 
<img style="height:150px" src="homePrompt.png"/>

Selecting 'Always' locks in EHS and locks users out of the following device features by default:
