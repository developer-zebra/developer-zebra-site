...
**Kiosk Mode should not be used with Screen Pinning**, a feature in Android L that works in much the same way. A prompt will appear if Kiosk Mode is selected without first disabling Screen Pinning**. 
