...
* **New [Screen Blanking feature](../settings/#screenblanking)** disables touch input when the device is in motion, adding a measure of safety when EHS is used in vehicle applicaions. 
