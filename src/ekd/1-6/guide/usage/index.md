...
* **Manual Push** from the development host to a USB-connected device **using the "Deploy" button** or [Android Debug Bridge](https://developer.android.com/studio/command-line/adb) (adb) commands  
