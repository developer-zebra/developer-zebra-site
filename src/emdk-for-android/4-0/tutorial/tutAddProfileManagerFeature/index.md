...
3. The EMDK Profile Manager Window will appear.
    ...
    ![img](/img/AddProfileManagerFeatureImage/emdk_profile_manager.jpg)

4. Click "Create" and assign a name for the profile (Ex: MyEMDKProfile).
  
    ![img](/img/AddProfileManagerFeatureImage/create_new_profile.jpg)
...
6. Click "Create" and the Profile Editor window will appear with a set of features on its left hand side.
	...
	![img](/img/AddProfileManagerFeatureImage/profile_editor_4.3.jpg) 
