...
4. Open this directory and you would see the Encrypted File System of size 5MB that we created (SampleEFS) through Profile Wizard.
    ...
    This is how you can create Encrypted File System (EFS) along with the installation of Encryption Key on the internal/external SD Card storage using [Encrypt Manager](/emdk-for-android/4-0/mx/security/encryptmgr) feature on Symbol devices through Profile Wizard. 
