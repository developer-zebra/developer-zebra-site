...
So now we will create a tutorial and configure the touch of your Symbol Android device by specifying touch mode using Mx [Touch Manager](/emdk-for-android/4-0/mx/device-configuration/touchmgr) feature. 
