...
**Windows** - Follow this [**guide**](/emdk-for-android/6-0/guide/setupAndroidStudio) to setup the EMDK for Android in Android Studio.

**Mac** - Follow this [**guide**](/emdk-for-android/6-0/guide/setupAndroidStudioMac) to manually setup the EMDK for Android in Android Studio.
