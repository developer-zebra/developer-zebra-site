...
content-items:
  - type: section
    ...
    url: /emdk-for-android/6-10/guide/barcode_scanning_guide
  - type: section
    level: 4
    ...
    url: /emdk-for-android/6-10/guide/reference/refbatteryintent
  - type: section
    level: 4
    title: General Programming Practices
    text: This guide contains various EMDK for Android programming tips.
    url: /emdk-for-android/6-10/guide/programming_practices
  - type: section
    level: 4
    ...
    url: /emdk-for-android/6-10/guide/notification-api
  - type: section
    level: 4
    ...
    url: /emdk-for-android/6-10/guide/personalshopper
  - type: section
    level: 4
    ...
    url: /emdk-for-android/6-10/guide/xmlresponseguide
  - type: section
    level: 4
  ...
  - type: section
    ...
    url: /emdk-for-android/6-10/guide/simulscan_guide
  - type: section
    level: 4
    ...
    url: /emdk-for-android/6-10/guide/udi_scanning_guide
