...
## Overview
This guide will walk you through creating an EMDK For Android application that will make use [Profile Config](/emdk-for-android/6-3/api/core/ProfileConfig) object to modify Profile Settings programmatically in order to get barcode data into your application using the [KeyStroke output](/emdk-for-android/6-3/mx/data-capture/keystroke) feature of [EMDK Profiles](/emdk-for-android/6-3/guide/profile-manager).
