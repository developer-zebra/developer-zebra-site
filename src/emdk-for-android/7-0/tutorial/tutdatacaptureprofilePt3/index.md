...
## What's Next
The [next tutorial](/emdk-for-android/6-10/tutorial/tutdatacaptureprofilePt4) will show you how to use the Intent Output as a Broadcast instead of starting an activity.
