...
This guide will walk you through creating an EMDK For Android application that will use [Data Capture Profiles](/emdk-for-android/7-0/mx/data-capture/barcode) to get barcode data into your application using the [KeyStroke output](/emdk-for-android/7-0/mx/data-capture/keystroke) feature of EMDK Profiles.
...
1. Click [here](/emdk-for-android/7-0/guide/profile-manager/) to see how to add a specific feature to A profile with the Profile Manager.
...
## What's Next
Now that you have learned the basics of an EMDK for Android application, the [next tutorial](/emdk-for-android/7-0/tutorial/tutdatacaptureprofilePt2)</a> will show you how to use the [Intent Output](/emdk-for-android/7-0/mx/data-capture/intent) feature of EMDK Profiles to handle Data Capture output programmatically.
