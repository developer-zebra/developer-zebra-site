...
description: Operates Push-to-Talk functions on a Zebra device without unlocking it  
downloads:
  - title: UsingPTT.zip
    url: 'UsingPTT.zip'
features:
...
####`DISCLAIMER:`
**Zebra does not recommend using this utility for production environments**. This app is an *<u>example</u>* of how to allow PTT functions while the Android screen is locked. **No Zebra support or warranty is expressed or implied**.  
...
Intent extras:
Intent.EXTRA_KEY_EVENT: The actual key event object (refer  HYPERLINK "https://developer.android.com/reference/android/view/KeyEvent" https://developer.android.com/reference/android/view/KeyEvent for details on key event objects).
