...
5. **Enable the EMDK library** in the application node of the manifest:  
...
3/4/21- Replaced step 5 with above per DC: 5. **Rebuild the project** (Build -> Make Project). 
    ...
    •  In the left-hand pane, **select "Plugins"** to bring up Plugin settings.<br>
