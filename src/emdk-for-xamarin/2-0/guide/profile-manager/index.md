...
Once you create your profiles using the Profile Manager, they will be bundled with your application and available to access using the [Profile Manager APIs](/emdk-for-xamarin/2-0/api/). These profiles will NOT be applied on the device until it is processed using these APIs.
...
Be sure to follow step by step instructions for using the Profile Manager and the associated API's in the [Getting Started Tutorial](/emdk-for-xamarin/2-0/tutorial/helloxamarin)
