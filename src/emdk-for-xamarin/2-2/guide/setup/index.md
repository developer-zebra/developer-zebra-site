...
- [Read the Visual Studio Setup Guide](/emdk-for-xamarin/2-2/guide/vs/setup)


Download and install the Xamarin Studio Add-in(Mac) using the Add-in Manager.

- [Read the Xamarin Studio Setup Guide](/emdk-for-xamarin/2-2/guide/xs/setup)


### 2) Install The Xamarin Component

- [Read the Xamarin Component Install Guide](/emdk-for-xamarin/2-2/guide/component/install)
...
- [Read the Profile Manager Overview Guide](/emdk-for-xamarin/2-2/guide/profile-manager)
...
- [Follow the Hello Xamarin tutorial](/emdk-for-xamarin/2-2/tutorial/helloxamarin)
