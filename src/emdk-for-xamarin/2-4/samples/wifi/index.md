...
download: 'https://github.com/Zebra/samples-emdkforxamarin-2_4/archive/ProfileWifiSample1.zip'
source: 'https://github.com/Zebra/samples-emdkforxamarin-2_4/tree/ProfileWifiSample1'
features:
  - Profile Manager
  - WiFi Manager
devices:
