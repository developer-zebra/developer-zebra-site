...
download: 'https://github.com/Zebra/samples-emdkforxamarin-2_3/archive/ProfileWifiSample1.zip'
source: 'https://github.com/Zebra/samples-emdkforxamarin-2_3/tree/ProfileWifiSample1'
features:
  - Profile Manager
  - WiFi Manager
devices:
