...
## Sample Code 
The Java bytecode shown below is the same as that in the download link above. It can be used by an EMM Agent app to convert JSON Managed Configuration objects into bundles for use on a Zebra Android device. [More info](guide/oemdev). 
