...
﻿<html>
  <head>
    ...
    <title>AutoLoadMode</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>AutoLoadMode Property of the AirBEAMSmart ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>AutoLoadMode</b> Property of the AirBEAMSmart ActiveX Object instructs the AirBEAM Smart client ActiveX object to use the AutoLoad mode.</p>
