...
﻿<html>
  <head>
    ...
    <title>AutoReboot</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>AutoReboot Property of the AirBEAMSmart ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>AutoReboot</b> Property of the AirBEAMSmart ActiveX Object instructs the AirBEAM Smart client to enable or disable Auto Reboot mode.</p>
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          ...
          <tr>
            <td class="clsSyntaxCells">
              <p>object.AutoReboot = [parameter]</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
