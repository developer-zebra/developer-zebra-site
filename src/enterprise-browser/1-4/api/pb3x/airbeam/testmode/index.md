...
﻿<html>
  <head>
    ...
    <title>TestMode</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>TestMode Property of the AirBEAMSmart ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>TestMode</b> Property of the AirBEAMSmart ActiveX Object instructs the AirBEAM Smart client to test the package when set to 'true'. The client tests for package updates, but does not load packages.</p>
