...
﻿<html>
  <head>
    ...
    <title>UploadPackage</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>UploadPackage Property of the AirBEAMSmart ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>UploadPackage</b> Property of the AirBEAMSmart ActiveX Object instructs the AirBEAM Smart client to process the package for upload.</p>
