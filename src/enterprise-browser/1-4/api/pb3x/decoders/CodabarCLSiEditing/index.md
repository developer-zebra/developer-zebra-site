...
﻿<html>
  <head>
    ...
    <title>CodabarCLSiEditing</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>CodabarCLSiEditing META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>CodabarCLSiEditing</b> META Tag is an action tag used to enable Codabar CLSi formatting.</p>
