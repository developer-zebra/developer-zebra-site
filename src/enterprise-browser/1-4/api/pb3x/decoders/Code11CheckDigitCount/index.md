---
title: Code11CheckDigitCount.md
productversion: '1.4'
...
﻿<html>
  <head>
    ...
    <title>Code11CheckDigitCount</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>Code11CheckDigitCount META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>Code11CheckDigitCount</b> META Tag is an action tag used to set the Code11CheckDigitCount property. The property can be set to verify 0, 1 or 2 check digits.</p>
