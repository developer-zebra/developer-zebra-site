---
title: Code11ReportCheckDigit.md
---
﻿<html>
  <head>
    ...
    <title>Code11ReportCheckDigit</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>Code11ReportCheckDigit META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>Code11ReportCheckDigit</b> META Tag is an action tag used to set the Code11 ReportCheckDigit property which enables reporting of the bar code check digit(s).</p>
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="../Scanner.html&#xA;						">Scanner</a> <a href="Code11.html&#xA;						">Code11</a> </BLOCKQUOTE><br></div>
    <hr size="1">
