...
﻿<html>
  <head>
    ...
    <title>Code128MaxLength</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>Code128MaxLength META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>Code128MaxLength</b> META Tag is an action tag used to set the Code128 MaxLength property.</p>
