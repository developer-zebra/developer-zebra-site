---
title: Code39ConvertToCode32.md
productversion: '1.4'
...
﻿<html>
  <head>
    ...
    <title>Code39ConvertToCode32</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>Code39ConvertToCode32 META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>Code39ConvertToCode32</b> META Tag is an action tag used to enable conversion from Code39 to Code32 bar code. If this flag is set, the bar code is converted to Code32, and Code32 parameters are used.</p>
