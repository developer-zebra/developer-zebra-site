...
﻿<html>
  <head>
    ...
    <title>Code39concatenation</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>Code39concatenation META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>Code39concatenation</b> META Tag is an action tag used to set the Code39concatenation property.</p>
