...
﻿<html>
  <head>
    ...
    <title>Codabar</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>Codabar</b> META Tag is an action tag used to enable or disable the Codabar decoder.</p>
