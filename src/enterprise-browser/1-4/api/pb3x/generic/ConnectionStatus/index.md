...
﻿<html>
  <head>
    ...
    <title>ConnectionStatus</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>ConnectionStatus Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>ConnectionStatus</b> Method of the Generic ActiveX Object retrieves the status of a named modem/serial connection.</p>
...
&lt;/script&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="RasConnect.html&#xA;						">RasConnect</a> <a href="RasDisconnect.html&#xA;						">RasDisconnect</a> </BLOCKQUOTE><br></div>
    <hr size="1">
