...
﻿<html>
  <head>
    ...
    <title>GetProcessExitCode</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>GetProcessExitCode Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>GetProcessExitCode</b> Method of the Generic ActiveX Object retrieves the exit code of a previously run LaunchProcessNonBlocking call.</p>
...
&lt;/script&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="LaunchProcess.html&#xA;						">LaunchProcess</a> <a href="LaunchProcessNonBlocking.html&#xA;						">LaunchProcessNonBlocking</a> </BLOCKQUOTE><br></div>
    <hr size="1">
