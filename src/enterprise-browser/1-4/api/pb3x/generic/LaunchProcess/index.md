...
﻿<html>
  <head>
    ...
    <title>LaunchProcess</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>LaunchProcess Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>LaunchProcess</b> Method of the Generic ActiveX Object launches a new process which blocks execution until the process terminates.</p>
