...
﻿<html>
  <head>
    ...
    <title>OEMInfo</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>OEMInfo Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>OEMInfo</b> Method of the Generic ActiveX Object retrieves the OEM Information String for the terminal.</p>
