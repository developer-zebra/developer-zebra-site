...
﻿<html>
  <head>
    ...
    <title>RasConnect</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>RasConnect Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>RasConnect</b> Method of the Generic ActiveX Object connects a specified modem/serial connection.</p>
