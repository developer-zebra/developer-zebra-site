...
﻿<html>
  <head>
    ...
    <title>RasDisconnect</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>RasDisconnect Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>RasDisconnect</b> Method of the Generic ActiveX Object disconnects a specified modem/serial connection.</p>
...
&lt;/script&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="ConnectionStatus.html&#xA;						">ConnectionStatus</a> <a href="RasConnect.html&#xA;						">RasConnect</a> </BLOCKQUOTE><br></div>
    <hr size="1">
