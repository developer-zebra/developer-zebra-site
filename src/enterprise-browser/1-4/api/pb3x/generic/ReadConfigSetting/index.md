...
﻿<html>
  <head>
    ...
    <title>ReadConfigSetting</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>ReadConfigSetting Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>ReadConfigSetting</b> Method of the Generic ActiveX Object reads a setting from the configuration file.</p>
...
&lt;/script&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="WriteConfigSetting.html&#xA;						">WriteConfigSetting</a> <a href="../Getting Started/ConfigurationSettings.html&#xA;						">ConfigurationSettings</a> </BLOCKQUOTE><br></div>
    <hr size="1">
