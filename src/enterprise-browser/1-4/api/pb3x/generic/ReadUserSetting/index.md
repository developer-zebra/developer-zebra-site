...
﻿<html>
  <head>
    ...
    <title>ReadUserSetting</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>ReadUserSetting Method of the Generic ActiveX Object</h1>
        </td>
    ...
    <p>
					The 
					<b>ReadUserSetting</b> Method of the Generic ActiveX Object reads a custom setting stored in the configuration file.</p>
...
&lt;/script&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="WriteUserSetting.html&#xA;						">WriteUserSetting</a> </BLOCKQUOTE><br></div>
    <hr size="1">
