...
* Mapping **requires a KeyCapture API**. [Read more](/enterprise-browser/1-4/api/keycapture). 
...
* [Additional restrictions](/enterprise-browser/1-4/api/keycapture?Remarks) apply to keycapture and keycode mapping. 
