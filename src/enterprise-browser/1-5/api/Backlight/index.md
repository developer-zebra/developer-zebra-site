...
## Methods
### on()
Turn on the screen backlight. N/A for Android devices, please use the [Wake API](/enterprise-browser/1-4/api/Wake) to keep the screen ON.
