...
1. Go to the [Enterprise Browser 1.4 download page](https://www.zebra.com/us/en/support-downloads/software/developer-tools/enterprise-browser.html) and get the following two DataWedge (`.DB`) profiles: 
