...
This tutorial covers the use of the Enterprise Browser [Printer API](/enterprise-browser/1-4/api-printing) and [PrinterZebra API](/enterprise-browser/1-4/api-printingzebra), as well as some of the typical considerations when working with USB and wireless printers. 
...
For more information, please refer to the [Printing Guide](/enterprise-browser/1-4/guide-printingGuide).
...
* One of [Zebra's USB-supported printers](/enterprise-browser/1-4/?Printers) or a third-party printer 
* A [USB "On-the-Go" cable](/enterprise-browser/1-4/guide-printingGuide) 
...
* Completion of one or more EB API tutorials ([Barcode API Tutorial](/enterprise-browser/1-4/guide-tutorial-barcode) at minimum)
...
For more information about how to include API modules, please refer to the [Printing API](/enterprise-browser/1-4/api-printing). 
...
<b> For USB connections, device must be in 'USB Host mode'</b> before the app is started. For more more information about this and other connection types, defaults and [parameters], please refer to the [Printer API reference](/enterprise-browser/1-4/api-printing) and its [Remarks section](/enterprise-browser/1-4/api-printing?Remarks).  
...
###Conclusion
This completes the Enterprise Browser Printing tutorial. For more information, please refer to the [Enterprise Browser Printer API documentation](/enterprise-browser/1-4/api-printing). 
