...
**EB 2.0 and higher can take advantage of a simplified interface and [page-based actions](../pageactions)**, which can execute JavaScript code and/or predefined commands based on the contents of a page. 
