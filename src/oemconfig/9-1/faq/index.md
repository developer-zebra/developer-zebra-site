...
A: Short for Unified Endpoint Management, a UEM system combines mobile device management (MDM) and enterprise mobility management (EMM) systems into a single client-management tool for laptops and desktops as well as phones, tablets and and other mobile computing devices.
