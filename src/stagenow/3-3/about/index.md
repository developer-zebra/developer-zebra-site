...
**StageNow v3.3 has been validated on devices with the following operating systems and MX versions**: 
...
> `IMPORTANT`:<br> 
> <u>**StageNow 3.3 has been validated on devices running Android 8.x Oreo and Android 7.x Nougat only**</u>.
