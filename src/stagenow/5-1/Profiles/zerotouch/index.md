...
> `IMPORTANT:` **The Zero Touch Wizard does NOT prevent the Android Setup Wizard from running** on a new device when first booted, or when following a Factory or Enterprise reset. **How to [bypass the Android Setup Wizard](../wipedevice/#setupwizardmanualbypass)**.
