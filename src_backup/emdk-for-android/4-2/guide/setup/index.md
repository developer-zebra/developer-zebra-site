...
**Windows** - Follow this [**guide**](/emdk-for-android/4-2/guide/setupAndroidStudio) to setup the EMDK for Android in Android Studio.

**Mac** - Follow this [**guide**](/emdk-for-android/4-2/guide/setupAndroidStudioMac) to manually setup the EMDK for Android in Android Studio.
